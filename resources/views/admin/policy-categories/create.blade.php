...
@section('Breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <a href="#"> Create New Policy Category</a>
        </li>
    </ol>
@stop
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">Register Policy Category</div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.policy-categories.store') }}">
                    {!! csrf_field() !!}
