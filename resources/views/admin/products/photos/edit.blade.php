    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.products.{id}.photos.update', [$product->id, $photo->id]) }}">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <img src="{{$photo->getImage()}}" style="width: 100%" alt="">
                        </div>
                    </div>
