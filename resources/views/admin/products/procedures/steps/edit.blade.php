    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.products.{id}.procedures.{procedureId}.steps.update', [$product->id, $procedure->id, $step->id]) }}">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
